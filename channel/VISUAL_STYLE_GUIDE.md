...
| `graphic` | Diagrams, timelines, maps, and other editor-created visual aids | relationship, timeline, comparison, process, hierarchy, flow, map |
...
**Note:** Maps are included under the `graphic` form as editor-created elements in DaVinci Resolve.
...
No paid or subscription sources. No generic stock footage marketplaces.

Primary sources:
- Internet Archive (Prelinger Archives, British Pathe, PD animation collections)
- Channel Asset Library (LanceDB-indexed at D:/Youtube/D. Mysteries Channel/3. Assets)
